            ...
            <div className='w-[84%] ml-[16%]'>
                <div className='pt-1'>
                    <input
                        ...
                        className="inp my-2 p-2 ml-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:outline-none"
                    />
                    <button onClick={()=>{console.log(search); fetchProducts()}} className='px-3 py-2 ml-3 bg-blue-500 text-white rounded-lg'>Search</button>
                </div>
                <div>
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10 w-[95%]">
